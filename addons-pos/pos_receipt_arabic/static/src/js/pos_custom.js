        ...
        class extends OrderReceipt {
            ...
            get receiptEnv() {
                if (this._receiptEnv.order.pos.company.country.code === 'SA') {
                    ...
                    receipt.product_name = this.get_product().english_name;
                    receipt.product_arabic_name = this.get_product().arabic_name;
                    var company = this.pos.company;
                    receipt.company.arabic_name = company.arabic_name;
                    receipt.name_compressed = result.name.substring(6);
